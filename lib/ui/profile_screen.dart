          ...
          if (snapshot.hasError) {
            return Center(
              child: Column(
                ...
                children: [
                  Text(s.profileLoadError, style: const TextStyle(color: Colors.redAccent)),
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                Center(
                  child: AvatarInitials(username: username, fullName: fullName, radius: 44),
                ),
                ...
                AnimatedBuilder(
                  ...
                  builder: (context, _) {
                    return SwitchListTile(
                      ...
                      title: Row(
                        children: [
                          const Icon(Icons.notifications_rounded, color: Color(0xFFCB7B2A), size: 22),
                          const SizedBox(width: 16),
                          Text(s.menuNotifications, style: const TextStyle(color: Colors.white, fontSize: 15)),
                        ],
                      ),
                      subtitle: Padding(
